...
export default async function MusicPage() {
  ...
  try {
    ...
    if (setting?.value) spotifyUrl = setting.value;
  } catch (e) {
        ...
        <div className={styles.spotifyWrapper}>
          ...
          {embedUrl ? (
            <iframe
              ...
              title="TPF Spotify Player"
            ></iframe>
          ) : (
            <div className={styles.noSpotify}>
              <p>No Spotify link set yet. Add one from the admin portal.</p>
            </div>
          )}
        </div>
